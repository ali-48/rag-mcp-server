    ...
    try {
        ...
        if (isCommandExecuted && !args.force) {
            ...
            return {
                content: [{
                        type: "text",
                        text: JSON.stringify(formatErrorResponse('COMMAND_ALREADY_EXECUTED', errorMessage, {
        ...
        if (!isInitialized) {
            ...
            return {
                content: [{
                        type: "text",
                        text: JSON.stringify(formatErrorResponse('RAG_NOT_INITIALIZED', errorMessage, {
        ...
        const formattedResponse = formatSuccessResponse(`Pipeline ${workflow.name} exécuté avec succès`, summary, {
            nextSteps: [
        ...
        return {
            content: [{
                    type: "text",
                    text: JSON.stringify(formatErrorResponse('PIPELINE_ORCHESTRATION_ERROR', error.message, {
                        notesForAI: [
