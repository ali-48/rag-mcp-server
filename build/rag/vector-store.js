...
async function getVectorStore() {
    if (!vectorStoreInstance) {
        ...
        vectorStoreInstance = new VectorStoreAdapter(underlyingStore, embeddingService);
 ...
 */
export async function getModelForContentType(contentType, language) {
 ...
 */
export async function getDimensionForModel(model) {
