...
describe("string-utils", () => {
  ...
  describe("cleanComment", () => {
    it("should clean Python comments", () => {
      expect(cleanComment("# This is a comment", "python")).toBe(
        "This is a comment",
      );
      expect(cleanComment("#   indented comment", "python")).toBe(
        "indented comment",
      );
    });

    it("should clean JavaScript/TypeScript comments", () => {
      expect(cleanComment("// This is a comment", "javascript")).toBe(
        "This is a comment",
      );
      expect(cleanComment("/* Multi-line comment */", "typescript")).toBe(
        "Multi-line comment",
      );
      expect(cleanComment("/**\n * Doc comment\n */", "javascript")).toBe(
        "Doc comment",
