...
import type { CheckpointManager } from '../../src/rag/checkpoints/checkpoint-manager.js';
import { FileStreamer, FileStreamerOptions, StreamingMetrics, testFileStreamerModule } from '../../src/rag/streaming/file-streamer.js';
...
describe('Tests unitaires pour FileStreamer', () => {
    ...
    const defaultOptions: FileStreamerOptions = {
    ...
    describe('Initialisation', () => {
        ...
        it('devrait accepter des options personnalisées', () => {
            const customOptions: FileStreamerOptions = {
    ...
    describe('Test de performance', () => {
        it('devrait gérer 1000 fichiers sans OOM (simulation)', async () => {
            ...
            const performanceOptions: FileStreamerOptions = {
                projectPath: mockProjectPath,
        ...
        it('devrait respecter la limite mémoire', async () => {
            const lowMemoryOptions: FileStreamerOptions = {
                projectPath: mockProjectPath,
    ...
    describe('Gestion des erreurs', () => {
        ...
        it('devrait gérer les fichiers trop grands', async () => {
            const smallLimitOptions: FileStreamerOptions = {
                projectPath: mockProjectPath,
    ...
    describe('Compatibilité avec le pipeline RAG', () => {
        it('devrait être compatible avec les options RAG v3', () => {
            const ragOptions: FileStreamerOptions = {
                projectPath: mockProjectPath,
