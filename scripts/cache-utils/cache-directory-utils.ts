...
/**
 * Options pour la création de la structure de cache
 */
export interface CacheStructureOptions {
  /** Répertoire racine du cache (ex: 'audit') */
  rootDir: string;
  /** Nom du sous-répertoire de cache (ex: 'ast-cache') */
  cacheDirName: string;
  /** Créer un fichier .gitignore pour le cache */
  createGitignore: boolean;
  /** Créer un fichier README pour le cache */
  createReadme: boolean;
  /** Contenu personnalisé pour le .gitignore */
  gitignoreContent?: string;
  /** Contenu personnalisé pour le README */
 ...
 */
export const DEFAULT_AST_CACHE_OPTIONS: CacheStructureOptions = {
  rootDir: 'audit',
 ...
 */
export function createCacheDirectories(options: CacheStructureOptions): string[] {
 ...
 */
export function setupGitignoreForCache(options: CacheStructureOptions): boolean {
 ...
 */
export function generateDefaultASTCacheReadme(): string {
 ...
 */
export function createCacheReadme(options: CacheStructureOptions): boolean {
 ...
 */
export function createASTCacheStructure(options: CacheStructureOptions = DEFAULT_AST_CACHE_OPTIONS): {
  directories: string[];
