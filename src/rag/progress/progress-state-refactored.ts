...
import type { RagJob } from "../queue/job-types.js";
import type {
  ProgressState,
...
import {
  calculateTimeEstimate as calculateTimeEstimateUtil,
  calculateWorkloadScore as calculateWorkloadScoreUtil,
  setupPhaseTransitions as setupPhaseTransitionsUtil,
  updatePhaseProgress as updatePhaseProgressUtil
} from "../../../scripts/progress-utils/phase-transition-utils.js";
import {
  initializeProgressStructure as initializeProgressStructureUtil
