 ...
 */
export function enrichSymbolMetadata(
  symbol: ExtractedSymbol,
  node: any,
  sourceCode: string,
  config: { calculateComplexity?: boolean }
): void {
 ...
 */
export function extractParameters(node: any, language: string): string[] {
 ...
 */
export function extractReturnType(node: any, language: string): string | undefined {
 ...
 */
export function extractVisibility(node: any, language: string): 'public' | 'private' | 'protected' {
 ...
 */
export function isStatic(node: any, language: string): boolean {
  const text = node.text || '';
 ...
 */
export function isAsync(node: any, language: string): boolean {
  const text = node.text || '';
 ...
 */
export function extractClassMembers(node: any, memberType: 'method' | 'property', language: string): string[] {
 ...
 * Extrait les imports
 */
export function extractImports(node: any, language: string): string[] {
 ...
 * Extrait les exports
 */
export function extractExports(node: any, language: string): string[] {
