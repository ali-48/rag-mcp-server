...
/**
 * Configuration de la redirection des logs
 */
export interface LogRedirectConfig {
    /**
     ...
     */
    redirectDebug?: boolean;

    /**
     * Inclure la pile d'appel dans les logs redirigés
     */
    includeStackTrace?: boolean;

    /**
     * Filtrer les messages par pattern (regex)
     */
    filterPattern?: RegExp;

    /**
     * Exclure les messages par pattern (regex)
     */
...
let currentConfig: LogRedirectConfig = {};

/**
 * Vérifie si un message doit être filtré
 */
function shouldFilter(message: string, config: LogRedirectConfig): boolean {
 ...
 */
function getCleanStackTrace(): string | undefined {
    try {
 ...
 */
export function redirectConsoleLogs(config: LogRedirectConfig = {}): void {
    if (isRedirected) {
 ...
 */
export function getRedirectConfig(): LogRedirectConfig {
 ...
 */
export function initializeLogRedirection(): void {
