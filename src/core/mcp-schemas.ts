...
import { JSONSchema, validateJsonSchema } from "./json-schema-validator.js";
...
export const manageProjectsInputSchema: JSONSchema = {
  ...
  properties: {
    ...
    project_path: {
      type: "string",
      description:
        "Chemin du projet pour les statistiques (requis pour 'stats')",
    },
  },
  additionalProperties: false,
};
...
export const queryRagInputSchema: JSONSchema = {
  ...
  properties: {
    ...
    dynamic_threshold: {
      type: "boolean",
      description:
        "Activer le seuil dynamique basé sur la distribution des scores",
      default: false,
    },
    search_mode: {
      type: "string",
    ...
    timeout_seconds: {
      type: "number",
      description:
        "Timeout en secondes pour la recherche (exception - conservé pour query_rag)",
      default: 30,
      minimum: 1,
      maximum: 300,
    },
...
export const queryRagOutputSchema: JSONSchema = {
  type: "object",
  properties: {
    status: {
      type: "string",
...
export const cancelTaskInputSchema: JSONSchema = {
  ...
  properties: {
    task_id: {
      type: "string",
      description:
        "ID de la tâche à annuler (obtenu via index_rag ou activated_rag)",
    },
    reason: {
      type: "string",
    ...
    force: {
      type: "boolean",
      description:
        "Forcer l'annulation même si la tâche est en cours d'exécution",
      default: false,
    },
  },
  required: ["task_id"],
...
export const cancelTaskOutputSchema: JSONSchema = {
  type: "object",
  properties: {
    success: {
      type: "boolean",
 ...
 */
export const listTasksInputSchema: JSONSchema = {
  type: "object",
  properties: {
    project_path: {
      type: "string",
      description:
        "Chemin du projet (optionnel, liste toutes les tâches si vide)",
    },
    state_filter: {
      type: "string",
...
export const listTasksOutputSchema: JSONSchema = {
  type: "object",
  properties: {
    success: {
      type: "boolean",
...
export function validateToolOutput(
  ...
  // Utiliser le validateur JSON Schema
  const result = validateJsonSchema(output, schema);
  return {
    valid: result.valid,
    errors: result.errors || [],
  };
