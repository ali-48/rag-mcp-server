...
/**
 * Types d'événements pour les tâches
 */
...
/**
 * Interface pour un événement de tâche
 */
export interface TaskEvent {
  ...
  payload: {
    task_status?: Partial<ProgressStatus>;
...
/**
 * Interface pour un écouteur d'événements
 */
 ...
 */
export interface TaskEventEmitterOptions {
  enableGatewayRouting?: boolean;
  gatewayUrl?: string;
  maxListeners?: number;
  logEvents?: boolean;
}
...
export class TaskEventEmitter {
  ...
  private options: TaskEventEmitterOptions;
  private gatewayClient: any = null;

  constructor(options: TaskEventEmitterOptions = {}) {
    this.options = {
   ...
   */
  private async initializeGatewayClient(): Promise<void> {
    try {
   ...
   */
  async emit(eventType: TaskEventType, taskId: string, projectPath: string, payload: any = {}): Promise<void> {
   ...
   */
  private async notifyListeners(eventType: TaskEventType, event: TaskEvent): Promise<void> {
   ...
   */
  private async routeViaGateway(event: TaskEvent): Promise<void> {
   ...
   */
  async emitTaskCreated(taskId: string, projectPath: string, metadata?: any): Promise<void> {
   ...
   */
  async emitTaskStarted(taskId: string, projectPath: string, metadata?: any): Promise<void> {
   ...
   */
  async emitTaskCompleted(taskId: string, projectPath: string, result?: any): Promise<void> {
   ...
   */
  async emitTaskFailed(taskId: string, projectPath: string, error: Error): Promise<void> {
   ...
   */
  async emitTaskCancelled(taskId: string, projectPath: string, reason?: string): Promise<void> {
   ...
   */
  async emitTaskProgress(taskId: string, projectPath: string, progress: number, step?: string): Promise<void> {
   ...
   */
  configure(options: Partial<TaskEventEmitterOptions>): void {
    this.options = {
      ...this.options,
      ...options
    };
   ...
   */
  getOptions(): TaskEventEmitterOptions {
    return { ...this.options };
  }
 ...
 */
export function getTaskEventEmitter(options?: TaskEventEmitterOptions): TaskEventEmitter {
  if (!taskEventEmitter) {
 ...
 */
export async function testTaskEventEmitter(): Promise<boolean> {
  try {
