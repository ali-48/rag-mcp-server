...
import { cleanComment, extractImportExportName, extractSymbolName, findChildByType, findNameNode } from '../../../src/rag/phase0/analyzer/symbol-extraction/symbol-name-extractor.js';
    ...
    describe('extractSymbolName', () => {
        it('should extract function name from TypeScript AST node', () => {
            const mockNode = {
                ...
                child: (i) => {
                    if (i === 0)
                        return { type: 'identifier', text: 'myFunction' };
                    return null;
                }
            };
        ...
        it('should extract class name from JavaScript AST node', () => {
            const mockNode = {
                ...
                child: (i) => {
                    if (i === 0)
                        return { type: 'identifier', text: 'MyClass' };
                    return null;
                }
            };
        ...
        it('should return null for unknown symbol type', () => {
            ...
            const name = extractSymbolName(mockNode, 'unknown', 'typescript');
    ...
    describe('findNameNode', () => {
        it('should find identifier node in AST', () => {
            const mockNode = {
                ...
                child: (i) => {
                    if (i === 0)
                        return { type: 'identifier', text: 'myFunc', childCount: 0 };
                    return null;
                }
            };
...
//# sourceMappingURL=symbol-name-extractor.test.js.map