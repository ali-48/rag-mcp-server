...
describe('Tests d\'intégration pour le workflow RAG asynchrone complet', () => {
    ...
    beforeEach(() => {
        ...
        StateManager.getInstance.mockReturnValue(mockStateManager);
        ...
        createRagJob.mockImplementation((type, projectPath, options) => {
            jobCounter++;
            return {
        ...
        mockRagQueue.getJob.mockImplementation((jobId) => {
        ...
        getTaskStatus.mockImplementation((job) => {
            return {
                task_id: job.id,
...
//# sourceMappingURL=async-workflow.test.js.map