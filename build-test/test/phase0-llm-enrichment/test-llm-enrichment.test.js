...
describe('Phase 0.3 - LLM Enrichment Unit Tests', () => {
    ...
    describe('4. Error Handling Tests', () => {
        ...
        it('4.1 - Validation échouée retourne null', async () => {
            ...
            vi.spyOn(enricher, 'validateEnrichmentInput').mockReturnValue({
                success: false,
        ...
        it('4.2 - Erreur LLM retourne null', async () => {
            ...
            vi.spyOn(enricher, 'callLLMForEnrichment').mockRejectedValue(new Error('LLM API error'));
        ...
        it('4.3 - Validation sortie LLM échouée retourne null', async () => {
            ...
            vi.spyOn(enricher, 'callLLMForEnrichment').mockResolvedValue({
    ...
    describe('5. Configuration Tests', () => {
        ...
        it('5.2 - Configuration personnalisée', () => {
            const customConfig = {
                ...
                temperature: 0.7,
                maxTokens: 2000,
                features: ['summary', 'complexity', 'category'],
            };
...
//# sourceMappingURL=test-llm-enrichment.test.js.map