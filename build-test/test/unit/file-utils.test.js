...
import { changeExtension, copyDirectory, copyFile, deleteDirectorySafe, deleteFileSafe, ensureDirectory, getDirectorySize, getFileNameWithoutExtension, getFileSize, hasExtension, isDirectory, isFile, listDirectories, listFiles, makeAbsolute, makeRelative, normalizePath, pathExists, readFileSafe, readJsonFile, walkDirectory, writeFileSafe } from "../../src/core/utils/file-utils.js";
describe("file-utils", () => {
    ...
    describe("readFileSafe", () => {
        ...
        it("should use specified encoding", () => {
            ...
            expect(readFileSafe(testFile, "binary")).toBe(binaryContent.toString("binary"));
        });
    });
    ...
    describe("walkDirectory", () => {
        ...
        it("should filter files", () => {
            const txtFiles = walkDirectory(testBaseDir, (filePath) => filePath.endsWith(".txt"));
    ...
    describe("changeExtension", () => {
        it("should change extension", () => {
            ...
            expect(changeExtension("/path/to/file.txt", ".json")).toBe("/path/to/file.json");
        });
    ...
    describe("readJsonFile", () => {
        beforeEach(() => {
            fs.mkdirSync(testBaseDir, { recursive: true });
            fs.writeFileSync(testJsonFile, JSON.stringify({ key: "value", number: 42 }));
        });
