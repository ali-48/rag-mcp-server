...
describe('Module B - rag-state.ts', () => {
    ...
    describe('B1 - isRagInitialized', () => {
        it('devrait retourner true si RAG est initialisé', async () => {
            ...
            expect(mockFs.promises.access).toHaveBeenCalledWith(expect.stringContaining('rag/config/rag.config.json'), expect.any(Number));
        });
...
//# sourceMappingURL=rag-state.test.js.map