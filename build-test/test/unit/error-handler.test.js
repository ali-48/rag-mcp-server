...
import { ErrorHandler, formatErrorForHuman, formatErrorForMCP, handleError, testErrorHandlerModule } from '../../src/rag/errors/error-handler.js';
...
describe('Tests unitaires pour ErrorHandler', () => {
    ...
    describe('Formatage MCP', () => {
        ...
        it('devrait formater une RagUsageError pour MCP avec actions requises', () => {
            const error = new RagUsageError('Le pipeline RAG doit être initialisé', 'RAG_PIPELINE_REQUIRED', {
    ...
    describe('Messages guidés pour RagUsageError', () => {
        it('devrait inclure l\'action requise dans le format MCP', () => {
            const error = new RagUsageError('Le système RAG n\'est pas initialisé', 'RAG_NOT_INITIALIZED', {
