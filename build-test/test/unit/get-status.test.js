...
describe('Tests unitaires pour l\'outil MCP get_status', () => {
    ...
    beforeEach(() => {
        ...
        getPhaseAnalysis.mockResolvedValue(mockPhaseAnalysis);
        ...
        getTaskStatus.mockReturnValue(mockTaskStatus);
    });
    afterEach(() => {
        vi.resetAllMocks();
    });
    ...
    describe('Scope projet', () => {
        ...
        it('devrait gérer les erreurs de getPhaseAnalysis', async () => {
            ...
            getPhaseAnalysis.mockRejectedValue(new Error('Erreur d\'analyse'));
            const args = {
                scope: 'project',
                project_id: 'test-project'
            };
