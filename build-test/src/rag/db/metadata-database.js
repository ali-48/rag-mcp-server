 ...
 */
export async function initializeMetadataDatabase(config = {}) {
    const { dbDir = '/rag/db', force = false, verbose = false } = config;
 ...
 */
export async function isMetadataDatabaseInitialized(dbDir = '/rag/db') {
    try {
        const sqliteInitializer = getSqliteInitializer(dbDir);
        const status = await sqliteInitializer.checkDatabaseStatus();
 ...
 */
export async function getMetadataDatabaseInfo(dbDir = '/rag/db') {
    const dbPath = path.join(dbDir, 'metadata.sqlite');
 ...
 */
export async function resetMetadataDatabase(dbDir = '/rag/db', backupDir) {
 ...
 */
export async function demonstrateMetadataDatabase() {
...
//# sourceMappingURL=metadata-database.js.map