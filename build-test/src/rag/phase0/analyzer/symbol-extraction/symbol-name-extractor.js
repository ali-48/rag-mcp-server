 ...
 */
export function extractSymbolName(node, symbolType, language) {
 ...
 */
export function findNameNode(node, language) {
 ...
 */
export function findChildByType(node, types) {
 ...
 */
export function extractImportExportName(node, language) {
...
//# sourceMappingURL=symbol-name-extractor.js.map