...
class SimpleDecisionIndexer {
    ...
    async indexDecision(decision) {
        ...
        try {
            ...
            await embedAndStore(this.projectPath, `task-decisions/${decision.task_id}/${decisionId}.json`, content, {
     ...
     */
    createDecisionContent(decision) {
        const parts = [];
...
//# sourceMappingURL=index-decision-simple.js.map